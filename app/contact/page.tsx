  ...
  return (
    <div className="mx-auto grid max-w-6xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
      ...
      <Card className="rounded-[32px] bg-white/90 p-6 sm:p-8">
        <form className="space-y-5" aria-describedby="contact-form-help contact-form-tip">
          ...
          <p id="contact-form-tip" className="text-sm text-stone-700">
            If you are not sure what to write, keep it short and tell us what you need help with.
          </p>
