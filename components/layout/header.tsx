    ...
    <header className="sticky top-0 z-50 border-b border-black/5 bg-surface/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3 rounded-2xl focus-ring">
          ...
          <div>
            <p className="font-display text-xl text-ink">Central Illinois Music Ministry Directory</p>
            <p className="text-sm text-stone-600">Musicians for churches, worship leaders, and ministry events</p>
          </div>
        </Link>
        ...
        <nav aria-label="Primary" className="hidden items-center gap-6 xl:flex">
          ...
          <a href={churchDirectoryUrl("/")} target="_blank" rel="noreferrer" className="text-sm font-medium text-stone-700 hover:text-brand-900 focus-ring">
            Browse Churches
          </a>
        </nav>
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <Button asChild>
            <Link href="/create-profile">Join the Directory</Link>
          </Button>
        </div>
