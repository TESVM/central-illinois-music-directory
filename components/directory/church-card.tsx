...
export function ChurchCard({ church }: { church: ChurchRecord }) {
  ...
  return (
    <Card className="overflow-hidden border-white/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(238,248,248,0.86))]">
      <div className="relative h-52">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm leading-7 text-stone-600">{church.shortDescription}</p>
        </div>
